...
Il est facile d'exporter un fichier Word en PDF et les éditeurs de Markdown proposent l'exportation en PDF. Par contre, un éditeur LaTeX donne beaucoup plus d'options d'édition :
...
- Possibilités d'édition : listes, boites, compositions d'images, entêtes, bas de page, tables de matières, des figures, des tableaux, citations et références, index multiples, etc.
